...
import io.osber1.ollama.llm.AnthropicProvider
import io.osber1.ollama.services.OllamaServerService
...
class OllamaToolWindow : ToolWindowFactory {
    override fun createToolWindowContent(project: Project, toolWindow: ToolWindow) {
        ...
        // Add settings action to a gear menu
...
class OllamaToolWindowContent(private val project: Project) {
    ...
    private fun startServer() {
        try {
            ...
            check(!apiKey.isBlank()) { "API key is required. Please set it in Settings -> Tools -> Ollama Proxy Settings." }
